...
function renderAiPlayerCard(ai) {
    ...
    return `<div class="ai-card" style="border-left-color:${ai.color};">
        ...
        <div class="ai-info-body">
            ...
            ${ai.bank > 0 ? `<div class="ai-info-row"><span class="ai-label">銀行存款：</span><span class="ai-holding" style="color:#27ae60;">${formatMoney(ai.bank)}</span></div>` : ''}
            ${ai.fundUnits > 0 ? `<div class="ai-info-row"><span class="ai-label">基金持有：</span><span class="ai-holding" style="color:#8e44ad;">${formatMoney(ai.fundUnits * fundNAV)}</span></div>` : ''}
